...
function deleteEvent() {
        ...
        if (eventIdToDelete) {
        // Add a check for associated contests here
        if (contests.some(contest => contest.event_id === eventIdToDelete)) {
            errorMessage = 'Can\'t Delete Contest! It is associated with an event';
            return;
        }

        // Proceed with deleting the event if no associated contests
        form.delete(route('events.destroy', { event: eventIdToDelete }));
    }
}
                    ...
                    <form @submit.prevent="submit">
                        <div class=" mt-2 flex justify-between">
                            ...
                            <div class="px-8 my-2 grid gap-y-2 grid-row-2">
                                ...
                                <button type="button" class="rounded px-24 py-2 bg-red-500 font-bold"  data-bs-toggle="modal" data-bs-target="#staticBackdrop" @click="confirmDelete(event.id)">Delete</button>
                            </div>
                        </div>
                    </form>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3 text-center" v-if="errorMessage">
